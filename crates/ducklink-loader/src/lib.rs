...
// in the storage / index / files pipeline. The stub therefore no longer
// exports any of them — only `callback-dispatch`, the two loader hooks, and
// the TVM spill imports remain.
#[allow(warnings)]
mod bindings;
