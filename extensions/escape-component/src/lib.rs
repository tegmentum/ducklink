//! HTML + URL encode/decode as DuckDB scalars (`html_escape`, `html_unescape`,
...
//! surface live ONCE in `escape-core` (datalink); the registration ABI, handle
