...
// Per-row scalar logic, UNCHANGED from the major-3 hand-written impl. typetest
// returns the FULL logical-type surface (int32/timestamp/decimal/uuid/...), which
// is OUTSIDE the neutral closed value set, so it cannot ride the `declare!`
// pull-up; the columnar_bridge! keeps the hand-written typed returns and supplies
// the major-4 colvec <-> row hot path that handles every Duckvalue arm.
fn scalar(
    handle: u32,
...
fn register_scalars() -> Result<(), types::Duckerror> {
    ...
    let extras: Vec<(&str, T, types::Logicaltype, &str)> = vec![
        (
            ...
            "returns 127 as TINYINT",
        ),
        (
            "tt_int16",
            T::Int16,
            types::Logicaltype::Int16,
            "returns 32767 as SMALLINT",
        ),
        (
            "tt_uint8",
            T::Uint8,
            types::Logicaltype::Uint8,
            "returns 255 as UTINYINT",
        ),
        (
            "tt_uint16",
            T::Uint16,
            types::Logicaltype::Uint16,
            "returns 65535 as USMALLINT",
        ),
        (
            "tt_uint32",
            T::Uint32,
            types::Logicaltype::Uint32,
            "returns 4294967295 as UINTEGER",
        ),
        (
            "tt_float32",
            T::Float32,
            types::Logicaltype::Float32,
            "returns 1.5 as FLOAT",
        ),
        (
            "tt_date",
            T::Date,
            types::Logicaltype::Date,
            "returns 2021-01-01 as DATE",
        ),
        (
            "tt_time",
            T::Time,
            types::Logicaltype::Time,
            "returns 12:34:56.789 as TIME",
        ),
        (
            "tt_timestamptz",
            T::Timestamptz,
            types::Logicaltype::Timestamptz,
            "returns 2021-01-01 as TIMESTAMP_TZ",
        ),
        (
            "tt_decimal",
            T::Decimal,
            types::Logicaltype::Decimal(types::Decimalshape {
                width: 38,
                scale: 4,
            }),
            "returns 12345.6789 as DECIMAL",
        ),
        (
            "tt_interval",
            T::Interval,
            types::Logicaltype::Interval,
            "returns 1 month 2 days 3s as INTERVAL",
        ),
        (
            "tt_uuid",
            T::Uuid,
            types::Logicaltype::Uuid,
            "returns a fixed UUID",
        ),
        ...
        (
            "tt_list",
            T::List,
            types::Logicaltype::Complex("INTEGER[]".into()),
            "returns [10,20,30] as INTEGER[]",
        ),
        (
            "tt_struct",
            T::Struct,
            types::Logicaltype::Complex("STRUCT(a INTEGER, b VARCHAR)".into()),
