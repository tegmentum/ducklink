//! Additional phonetic codes (nysiis/refined_soundex/double_metaphone) for DuckDB.
//!
...
//! surface live ONCE in `phonetic2-core` (datalink); the registration ABI, handle
