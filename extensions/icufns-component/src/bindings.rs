        ...
        pub mod collation {
            ...
            pub fn register_collation(
                ...
                unsafe {
                    ...
                    let ptr2 = ret_area.0.as_mut_ptr().cast::<u8>();
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "duckdb:extension/collation@2.2.0")]
                    unsafe extern "C" {
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:duckdb:extension@2.2.0:duckdb-extension-collation:encoded world"
)]
#[doc(hidden)]
...
\x04\0\x12register-collation\x01\x03\x03\0\x20duckdb:extension/collation@2.2.0\x05\
...
duckdb:extension/guest@2.2.0\x05\x17\x01B\x1c\x02\x03\x02\x01\x02\x04\0\x09ducke\
...
ast\x01\x15\x04\0(duckdb:extension/callback-dispatch@2.2.0\x05\x18\x04\01duckdb:\
extension/duckdb-extension-collation@2.2.0\x04\0\x0b\x20\x01\0\x1aduckdb-extensi\
