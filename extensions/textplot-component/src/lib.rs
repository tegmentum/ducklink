//! textplot: text/terminal visualization (sparkline / bars / QR) for DuckDB.
//!
...
//! surface live ONCE in `textplot-core` (datalink); the registration ABI,
