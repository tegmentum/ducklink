...
use exports::duckdb::extension::{file_dispatch, guest};
...
// Per-row scalar logic (the `s3fs_version` marker), UNCHANGED. The major-4
// columnar dispatch is generated by `datalink_extcore::columnar_bridge!`; s3fs's
// real surface is the filesystem `file_dispatch` impl below, untouched.
fn scalar(
    _h: u32,
