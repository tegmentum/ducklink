        ...
        pub mod index {
            ...
            pub fn register_index_type(type_name: &str) -> Result<(), Duckerror> {
                unsafe {
                    ...
                    let ptr1 = ret_area.0.as_mut_ptr().cast::<u8>();
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "duckdb:extension/index@2.2.0")]
                    unsafe extern "C" {
    ...
    pub mod duckdb {
        pub mod extension {
            ...
            pub mod index_dispatch {
                ...
                #[doc(hidden)]
                macro_rules! __export_duckdb_extension_index_dispatch_2_2_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "duckdb:extension/index-dispatch@2.2.0#index-create")] unsafe
                        ...
                        "cabi_post_duckdb:extension/index-dispatch@2.2.0#index-create")]
                        unsafe extern "C" fn _post_return_index_create(arg0 : * mut u8,)
                        { unsafe { $($path_to_types)*:: __post_return_index_create::<$ty
                        > (arg0) } } #[unsafe (export_name =
                        "duckdb:extension/index-dispatch@2.2.0#index-append")] unsafe
                ...
                #[doc(hidden)]
                pub(crate) use __export_duckdb_extension_index_dispatch_2_2_0_cabi;
                #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                struct _RetArea(
                    [::core::mem::MaybeUninit<
...
macro_rules! __export_duckdb_extension_index_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        ...
        exports::duckdb::extension::index_dispatch::__export_duckdb_extension_index_dispatch_2_2_0_cabi!($ty
        with_types_in $($path_to_types_root)*::
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:duckdb:extension@2.2.0:duckdb-extension-index:encoded world"
)]
#[doc(hidden)]
...
:extension/files@2.2.0\x05\x14\x01B\x05\x02\x03\x02\x01\x02\x04\0\x09duckerror\x03\
\0\0\x01j\0\x01\x01\x01@\x01\x09type-names\0\x02\x04\0\x13register-index-type\x01\
\x03\x03\0\x1cduckdb:extension/index@2.2.0\x05\x15\x02\x03\0\0\x0aloadresult\x01\
...
@\0\0\x07\x04\0\x08shutdown\x01\x09\x04\0\x1cduckdb:extension/guest@2.2.0\x05\x17\
...
lback-dispatch@2.2.0\x05\x18\x01B\x14\x02\x03\x02\x01\x02\x04\0\x09duckerror\x03\
...
extension/index-dispatch@2.2.0\x05\x19\x04\0-duckdb:extension/duckdb-extension-i\
ndex@2.2.0\x04\0\x0b\x1c\x01\0\x16duckdb-extension-index\x03\0\0\0G\x09producers\
