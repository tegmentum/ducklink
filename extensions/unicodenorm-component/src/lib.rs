//! unicodenorm: Unicode normalization (NFC/NFD/NFKC/NFKD) for DuckDB.
//!
...
//! surface live ONCE in `unicodenorm-core` (datalink); the registration ABI,
//! handle table, dispatch arms (incl. the major-4 columnar hot path), and the
