//! uuid5: namespace (name-based) UUIDs (uuid_v5 / uuid_v3) for DuckDB.
//!
...
//! surface live ONCE in `uuid5-core` (datalink); the registration ABI, handle
//! table, dispatch arms (incl. the major-4 columnar hot path), and the
