...
fn scalar_name_by_arm_idx(arm: usize) -> Option<&'static str> {
    match arm as u32 {
        0 => Some("time_bucket"),
        1 => Some("time_bucket_gapfill"),
        2 => Some("time_bucket_range"),
        _ => None,
    }
}
...
fn register_scalars() -> Result<(), Duckerror> {
    ...
    };
    {
        ...
        let opts = runtime::Funcopts {
            description: Some("time_bucket (sqlink-shim-codegen --dynlink)".into()),
            tags: vec!["time_bucket".into()],
    ...
    }
    {
        ...
        let opts = runtime::Funcopts {
            description: Some("time_bucket_gapfill (sqlink-shim-codegen --dynlink)".into()),
            tags: vec!["time_bucket_gapfill".into()],
            attributes: Funcflags::DETERMINISTIC | Funcflags::STATELESS,
        };
        registry.register(
            "time_bucket_gapfill",
    ...
    }
    {
        ...
        let opts = runtime::Funcopts {
            description: Some("time_bucket_range (sqlink-shim-codegen --dynlink)".into()),
            tags: vec!["time_bucket_range".into()],
            attributes: Funcflags::DETERMINISTIC | Funcflags::STATELESS,
        };
        registry.register(
            "time_bucket_range",
