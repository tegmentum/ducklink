...
// major-4 columnar dispatch: the three columnar hot methods + the whole
// callback_dispatch impl are generated by `columnar_bridge!`, which bridges
// `colvec` <-> row and delegates to the unchanged per-row `scalar` / `cast`
// free fns below.
