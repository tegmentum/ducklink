        ...
        pub mod optimizer {
            ...
            pub fn register_optimizer_rule(
                ...
                unsafe {
                    ...
                    let ptr1 = ret_area.0.as_mut_ptr().cast::<u8>();
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "duckdb:extension/optimizer@3.0.0")]
                    unsafe extern "C" {
    ...
    pub mod duckdb {
        pub mod extension {
            ...
            pub mod optimizer_dispatch {
                ...
                #[doc(hidden)]
                macro_rules! __export_duckdb_extension_optimizer_dispatch_3_0_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "duckdb:extension/optimizer-dispatch@3.0.0#call-optimize")]
                        ...
                        "cabi_post_duckdb:extension/optimizer-dispatch@3.0.0#call-optimize")]
                ...
                #[doc(hidden)]
                pub(crate) use __export_duckdb_extension_optimizer_dispatch_3_0_0_cabi;
                #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                struct _RetArea(
                    [::core::mem::MaybeUninit<
...
macro_rules! __export_duckdb_extension_optimizer_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        ...
        exports::duckdb::extension::optimizer_dispatch::__export_duckdb_extension_optimizer_dispatch_3_0_0_cabi!($ty
        with_types_in $($path_to_types_root)*::
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:duckdb:extension@3.0.0:duckdb-extension-optimizer:encoded world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 5740] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xdb+\x01A\x02\x01A$\x01\
...
register-optimizer-rule\x01\x03\x03\0\x20duckdb:extension/optimizer@3.0.0\x05\x15\
\x02\x03\0\0\x0aloadresult\x01B\x0d\x02\x03\x02\x01\x02\x04\0\x09duckerror\x03\0\
\0\x02\x03\x02\x01\x16\x04\0\x0aloadresult\x03\0\x02\x01j\x01\x03\x01\x01\x01@\0\
...
ckdb:extension/guest@3.0.0\x05\x17\x01B\x1c\x02\x03\x02\x01\x02\x04\0\x09duckerr\
...
\x15\x04\0(duckdb:extension/callback-dispatch@3.0.0\x05\x18\x01B\x0f\x02\x03\x02\
\x01\x02\x04\0\x09duckerror\x03\0\0\x01ky\x01r\x04\x02idy\x07op-types\x06parent\x02\
\x0bparams-jsons\x04\0\x09plan-node\x03\0\x03\x01p\x04\x01r\x02\x05nodes\x05\x05\
querys\x04\0\x0aplan-shape\x03\0\x06\x01r\x03\x06targety\x09directives\x09args-j\
sons\x04\0\x12structured-rewrite\x03\0\x08\x01q\x03\x08declined\0\0\x0drewrite-q\
uery\x01s\0\x05apply\x01\x09\0\x04\0\x11rewrite-directive\x03\0\x0a\x01j\x01\x0b\
\x01\x01\x01@\x02\x06handley\x04plan\x07\0\x0c\x04\0\x0dcall-optimize\x01\x0d\x04\
\0)duckdb:extension/optimizer-dispatch@3.0.0\x05\x19\x04\01duckdb:extension/duck\
db-extension-optimizer@3.0.0\x04\0\x0b\x20\x01\0\x1aduckdb-extension-optimizer\x03\
