//! Great-circle distance as DuckDB scalars (`haversine_km`, `haversine_mi`).
//!
...
//! surface live ONCE in `haversine-core` (datalink); the registration ABI,
