        ...
        pub mod storage {
            ...
            pub fn register_storage(
                ...
                unsafe {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "duckdb:extension/storage@3.0.0")]
                    unsafe extern "C" {
    ...
    pub mod duckdb {
        pub mod extension {
            ...
            pub mod storage_dispatch {
                ...
                #[doc(hidden)]
                macro_rules! __export_duckdb_extension_storage_dispatch_3_0_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "duckdb:extension/storage-dispatch@3.0.0#storage-attach")] unsafe
                        ...
                        "cabi_post_duckdb:extension/storage-dispatch@3.0.0#storage-attach")]
                        unsafe extern "C" fn _post_return_storage_attach(arg0 : * mut
                        u8,) { unsafe { $($path_to_types)*::
                        __post_return_storage_attach::<$ty > (arg0) } } #[unsafe
                        (export_name =
                        "duckdb:extension/storage-dispatch@3.0.0#attach-blob")] unsafe
                        extern "C" fn export_attach_blob(arg0 : i32, arg1 : * mut u8,
                        arg2 : usize, arg3 : * mut u8, arg4 : usize,) -> * mut u8 {
                        unsafe { $($path_to_types)*:: _export_attach_blob_cabi::<$ty >
                        (arg0, arg1, arg2, arg3, arg4) } } #[unsafe (export_name =
                        "cabi_post_duckdb:extension/storage-dispatch@3.0.0#attach-blob")]
                        unsafe extern "C" fn _post_return_attach_blob(arg0 : * mut u8,) {
                        unsafe { $($path_to_types)*:: __post_return_attach_blob::<$ty >
                        (arg0) } } #[unsafe (export_name =
                        "duckdb:extension/storage-dispatch@3.0.0#storage-list-tables")]
                        unsafe extern "C" fn export_storage_list_tables(arg0 : i32, arg1
                        : i32,) -> * mut u8 { unsafe { $($path_to_types)*::
                        _export_storage_list_tables_cabi::<$ty > (arg0, arg1) } }
                        #[unsafe (export_name =
                        "cabi_post_duckdb:extension/storage-dispatch@3.0.0#storage-list-tables")]
                        unsafe extern "C" fn _post_return_storage_list_tables(arg0 : *
                        mut u8,) { unsafe { $($path_to_types)*::
                        __post_return_storage_list_tables::<$ty > (arg0) } } #[unsafe
                        (export_name =
                        "duckdb:extension/storage-dispatch@3.0.0#storage-table-columns")]
                        ...
                        "cabi_post_duckdb:extension/storage-dispatch@3.0.0#storage-table-columns")]
                        unsafe extern "C" fn _post_return_storage_table_columns(arg0 : *
                        mut u8,) { unsafe { $($path_to_types)*::
                        __post_return_storage_table_columns::<$ty > (arg0) } } #[unsafe
                        (export_name =
                        "duckdb:extension/storage-dispatch@3.0.0#storage-scan-open")]
                        ...
                        * mut u8 { unsafe { $($path_to_types)*::
                        ...
                        "cabi_post_duckdb:extension/storage-dispatch@3.0.0#storage-scan-open")]
                        unsafe extern "C" fn _post_return_storage_scan_open(arg0 : * mut
                        u8,) { unsafe { $($path_to_types)*::
                        __post_return_storage_scan_open::<$ty > (arg0) } } #[unsafe
                        (export_name =
                        "duckdb:extension/storage-dispatch@3.0.0#storage-scan-next")]
                        unsafe extern "C" fn export_storage_scan_next(arg0 : i32, arg1 :
                        i32, arg2 : i32,) -> * mut u8 { unsafe { $($path_to_types)*::
                        _export_storage_scan_next_cabi::<$ty > (arg0, arg1, arg2) } }
                        #[unsafe (export_name =
                        "cabi_post_duckdb:extension/storage-dispatch@3.0.0#storage-scan-next")]
                        unsafe extern "C" fn _post_return_storage_scan_next(arg0 : * mut
                        u8,) { unsafe { $($path_to_types)*::
                        __post_return_storage_scan_next::<$ty > (arg0) } } #[unsafe
                        (export_name =
                        "duckdb:extension/storage-dispatch@3.0.0#storage-scan-close")]
                        unsafe extern "C" fn export_storage_scan_close(arg0 : i32, arg1 :
                        i32,) -> * mut u8 { unsafe { $($path_to_types)*::
                        _export_storage_scan_close_cabi::<$ty > (arg0, arg1) } } #[unsafe
                        (export_name =
                        "cabi_post_duckdb:extension/storage-dispatch@3.0.0#storage-scan-close")]
                        unsafe extern "C" fn _post_return_storage_scan_close(arg0 : * mut
                        u8,) { unsafe { $($path_to_types)*::
                        __post_return_storage_scan_close::<$ty > (arg0) } } #[unsafe
                        (export_name =
                        "duckdb:extension/storage-dispatch@3.0.0#storage-detach")] unsafe
                        extern "C" fn export_storage_detach(arg0 : i32, arg1 : i32,) -> *
                        mut u8 { unsafe { $($path_to_types)*::
                        _export_storage_detach_cabi::<$ty > (arg0, arg1) } } #[unsafe
                        (export_name =
                        "cabi_post_duckdb:extension/storage-dispatch@3.0.0#storage-detach")]
                ...
                #[doc(hidden)]
                pub(crate) use __export_duckdb_extension_storage_dispatch_3_0_0_cabi;
                #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                struct _RetArea(
                    [::core::mem::MaybeUninit<
...
macro_rules! __export_duckdb_extension_storage_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        ...
        exports::duckdb::extension::storage_dispatch::__export_duckdb_extension_storage_dispatch_3_0_0_cabi!($ty
        with_types_in $($path_to_types_root)*::
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:duckdb:extension@3.0.0:duckdb-extension-storage:encoded world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 6189] = *b"\
...
:extension/files@3.0.0\x05\x14\x01B\x13\x02\x03\x02\x01\x02\x04\0\x09duckerror\x03\
...
\0\x10register-storage\x01\x11\x03\0\x1educkdb:extension/storage@3.0.0\x05\x15\x02\
\x03\0\0\x0aloadresult\x01B\x0d\x02\x03\x02\x01\x02\x04\0\x09duckerror\x03\0\0\x02\
\x03\x02\x01\x16\x04\0\x0aloadresult\x03\0\x02\x01j\x01\x03\x01\x01\x01@\0\0\x04\
...
:extension/guest@3.0.0\x05\x17\x01B\x1c\x02\x03\x02\x01\x02\x04\0\x09duckerror\x03\
...
\x15\x04\0(duckdb:extension/callback-dispatch@3.0.0\x05\x18\x02\x03\0\x06\x0csca\
n-request\x01B#\x02\x03\x02\x01\x02\x04\0\x09duckerror\x03\0\0\x02\x03\x02\x01\x0b\
\x04\0\x09columndef\x03\0\x02\x02\x03\x02\x01\x09\x04\0\x09resultset\x03\0\x04\x02\
\x03\x02\x01\x19\x04\0\x0cscan-request\x03\0\x06\x01o\x02ss\x01p\x08\x01j\x01y\x01\
\x01\x01@\x03\x06handley\x03dsns\x07options\x09\0\x0a\x04\0\x0estorage-attach\x01\
\x0b\x01p}\x01j\0\x01\x01\x01@\x03\x06handley\x03dsns\x05bytes\x0c\0\x0d\x04\0\x0b\
attach-blob\x01\x0e\x01ps\x01j\x01\x0f\x01\x01\x01@\x02\x06handley\x07catalogy\0\
\x10\x04\0\x13storage-list-tables\x01\x11\x01p\x03\x01j\x01\x12\x01\x01\x01@\x03\
\x06handley\x07catalogy\x05tables\0\x13\x04\0\x15storage-table-columns\x01\x14\x01\
@\x03\x06handley\x07catalogy\x07request\x07\0\x0a\x04\0\x11storage-scan-open\x01\
\x15\x01j\x01\x05\x01\x01\x01@\x03\x06handley\x04scany\x08max-rowsy\0\x16\x04\0\x11\
storage-scan-next\x01\x17\x01j\x01\x7f\x01\x01\x01@\x02\x06handley\x04scany\0\x18\
\x04\0\x12storage-scan-close\x01\x19\x01@\x02\x06handley\x07catalogy\0\x18\x04\0\
\x0estorage-detach\x01\x1a\x04\0'duckdb:extension/storage-dispatch@3.0.0\x05\x1a\
\x04\0/duckdb:extension/duckdb-extension-storage@3.0.0\x04\0\x0b\x1e\x01\0\x18du\
ckdb-extension-storage\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-co\
