        ...
        pub mod storage {
            ...
            pub fn register_storage(
                ...
                unsafe {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "duckdb:extension/storage@2.0.0")]
                    unsafe extern "C" {
    ...
    pub mod duckdb {
        pub mod extension {
            ...
            pub mod storage_dispatch {
                ...
                #[doc(hidden)]
                macro_rules! __export_duckdb_extension_storage_dispatch_2_0_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "duckdb:extension/storage-dispatch@2.0.0#storage-attach")] unsafe
                        ...
                        #[unsafe (export_name =
                        "cabi_post_duckdb:extension/storage-dispatch@2.0.0#storage-list-tables")]
                        unsafe extern "C" fn _post_return_storage_list_tables(arg0 : *
                        mut u8,) { unsafe { $($path_to_types)*::
                        __post_return_storage_list_tables::<$ty > (arg0) } } #[unsafe
                        (export_name =
                        "duckdb:extension/storage-dispatch@2.0.0#storage-table-columns")]
                        ...
                        "cabi_post_duckdb:extension/storage-dispatch@2.0.0#storage-table-columns")]
                        unsafe extern "C" fn _post_return_storage_table_columns(arg0 : *
                        mut u8,) { unsafe { $($path_to_types)*::
                        __post_return_storage_table_columns::<$ty > (arg0) } } #[unsafe
                        (export_name =
                        "duckdb:extension/storage-dispatch@2.0.0#storage-scan-open")]
                        ...
                        * mut u8 { unsafe { $($path_to_types)*::
                        ...
                        "cabi_post_duckdb:extension/storage-dispatch@2.0.0#storage-scan-open")]
                        unsafe extern "C" fn _post_return_storage_scan_open(arg0 : * mut
                        u8,) { unsafe { $($path_to_types)*::
                        __post_return_storage_scan_open::<$ty > (arg0) } } #[unsafe
                        (export_name =
                        "duckdb:extension/storage-dispatch@2.0.0#storage-scan-next")]
                ...
                #[doc(hidden)]
                pub(crate) use __export_duckdb_extension_storage_dispatch_2_0_0_cabi;
                #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                struct _RetArea(
                    [::core::mem::MaybeUninit<
...
macro_rules! __export_duckdb_extension_storage_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        ...
        exports::duckdb::extension::storage_dispatch::__export_duckdb_extension_storage_dispatch_2_0_0_cabi!($ty
        with_types_in $($path_to_types_root)*::
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:duckdb:extension@2.0.0:duckdb-extension-storage:encoded world"
)]
#[doc(hidden)]
...
:extension/files@2.0.0\x05\x14\x01B\x13\x02\x03\x02\x01\x02\x04\0\x09duckerror\x03\
...
\0\x10register-storage\x01\x11\x03\0\x1educkdb:extension/storage@2.0.0\x05\x15\x02\
...
:extension/guest@2.0.0\x05\x17\x01B\x1c\x02\x03\x02\x01\x02\x04\0\x09duckerror\x03\
...
\x15\x04\0(duckdb:extension/callback-dispatch@2.0.0\x05\x18\x02\x03\0\x06\x0csca\
...
\x0estorage-detach\x01\x1a\x04\0'duckdb:extension/storage-dispatch@2.0.0\x05\x1a\
\x04\0/duckdb:extension/duckdb-extension-storage@2.0.0\x04\0\x0b\x1e\x01\0\x18du\
