//! Classic hex dumps of bytes as DuckDB scalars (`hexdump`, `hex_pretty`).
//!
...
//! surface live ONCE in `hexdump-core` (datalink); the registration ABI, handle
