//! Top-K frequent-items / heavy-hitters as DuckDB scalars (`top_k`,
//! `top_k_value`).
//!
...
//! surface live ONCE in `frequentitems-core` (datalink); the registration ABI,
