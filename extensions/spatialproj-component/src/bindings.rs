...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:duckdb:extension@2.2.0:spatialproj:encoded world"
)]
#[doc(hidden)]
...
\x15\x04\0(duckdb:extension/callback-dispatch@2.2.0\x05\x1b\x04\0\"duckdb:extens\
ion/spatialproj@2.2.0\x04\0\x0b\x11\x01\0\x0bspatialproj\x03\0\0\0G\x09producers\
