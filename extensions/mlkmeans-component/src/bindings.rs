...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_mlkmeans_impl {
    ($ty:ident) => {
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:duckdb:extension@4.0.0:mlkmeans:encoded world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 7163] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xfc6\x01A\x02\x01A)\x01\
...
h@4.0.0\x05\x1d\x04\0\x1fduckdb:extension/mlkmeans@4.0.0\x04\0\x0b\x0e\x01\0\x08\
mlkmeans\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x070.2\
