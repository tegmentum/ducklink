        ...
        pub mod parser {
            ...
            pub fn register_parser_extension(
                ...
                unsafe {
                    ...
                    let ptr1 = ret_area.0.as_mut_ptr().cast::<u8>();
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "duckdb:extension/parser@3.0.0")]
                    unsafe extern "C" {
    ...
    pub mod duckdb {
        pub mod extension {
            ...
            pub mod parser_dispatch {
                ...
                #[doc(hidden)]
                macro_rules! __export_duckdb_extension_parser_dispatch_3_0_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "duckdb:extension/parser-dispatch@3.0.0#call-parse")] unsafe
                        extern "C" fn export_call_parse(arg0 : i32, arg1 : * mut u8, arg2
                        : usize,) -> * mut u8 { unsafe { $($path_to_types)*::
                        _export_call_parse_cabi::<$ty > (arg0, arg1, arg2) } } #[unsafe
                        (export_name =
                        "cabi_post_duckdb:extension/parser-dispatch@3.0.0#call-parse")]
                ...
                #[doc(hidden)]
                pub(crate) use __export_duckdb_extension_parser_dispatch_3_0_0_cabi;
                #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                struct _RetArea(
                    [::core::mem::MaybeUninit<
...
macro_rules! __export_duckdb_extension_parser_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        ...
        exports::duckdb::extension::parser_dispatch::__export_duckdb_extension_parser_dispatch_3_0_0_cabi!($ty
        with_types_in $($path_to_types_root)*::
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:duckdb:extension@3.0.0:duckdb-extension-parser:encoded world"
)]
#[doc(hidden)]
...
ster-parser-extension\x01\x03\x03\0\x1dduckdb:extension/parser@3.0.0\x05\x15\x02\
...
\x15\x04\0(duckdb:extension/callback-dispatch@3.0.0\x05\x18\x01B\x07\x02\x03\x02\
...
\0\x04\x04\0\x0acall-parse\x01\x05\x04\0&duckdb:extension/parser-dispatch@3.0.0\x05\
\x19\x04\0.duckdb:extension/duckdb-extension-parser@3.0.0\x04\0\x0b\x1d\x01\0\x17\
