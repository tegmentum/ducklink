//! Verhoeff / Damm check digits for DuckDB.
//!
...
//! surface live ONCE in `checkdigit-core` (datalink); the registration ABI,
//! the dispatch arms (incl. the major-4 columnar hot path), and the
