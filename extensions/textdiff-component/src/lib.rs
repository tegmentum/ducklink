//! textdiff: text diffing (unified diff / ratio / changed lines) for DuckDB.
//!
...
//! surface live ONCE in `textdiff-core` (datalink); the registration ABI,
