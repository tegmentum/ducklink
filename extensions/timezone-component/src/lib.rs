//! timezone: IANA timezone lookups (valid / offset / abbreviation) for DuckDB.
//!
...
//! surface live ONCE in `timezone-core` (datalink); the registration ABI,
